...
activities = {
    ...
    "Soccer Club": {
        "description": "Outdoor soccer games and recreational sports",
    ...
    "Debate Team": {
        "description": "Develop argumentation skills through competitive debate",
        "schedule": "Mondays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["grace@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Club": {
        "description": "Experimental science projects and STEM exploration",
